            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Gender /</span> Table Gender
                        </h4>
                        <div class="card-body">
                            <a href="http://localhost/ppmnew/gender_admin/tambah.php">
                                ...
                                <table class="table">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        ...
                                        if (isset($_GET['query'])) {
                                            ...
                                            $get_data = mysqli_query($conn, "SELECT * FROM pm_gender");
                                        }
