            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Gender / Table Gender /</span> Detail <?= $gender['judul']; ?></h4>
                        <div class="row mb-5">
                            <div class="col-md-6 col-lg-12">
                                <h5 class="mt-2 text-muted"><?= $gender['judul']; ?></h5>
                                <div class="card mb-4">
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item">Author &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : <?= $gender['author']; ?></li>
                                        <li class="list-group-item">Description &nbsp;&nbsp;&nbsp;&nbsp; : <?= $gender['text']; ?></li>

                                        <li class="list-group-item">Data &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : <a href="download.php?filename=<?= urlencode($gender['data']); ?>"> 
                                        <i class="<?= getFileIcon($gender['data']); ?>"> </i> <?= $gender['data']; ?></li>
                                        <li class="list-group-item">Date &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : <?= $gender['tanggal']; ?></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
