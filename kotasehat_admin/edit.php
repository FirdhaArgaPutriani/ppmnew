...
$title = 'Edit Kota Sehat';

$id_kotasehat = $_GET['id'];
$query = mysqli_query($conn, "SELECT * FROM p_kotasehat WHERE id = $id_kotasehat");
$kotasehat = mysqli_fetch_assoc($query);
...
if (isset($_POST['submit'])) {
    ...
    if ($_FILES['file']['tmp_name']) {
        $target_dir     = '../assets/data/kotasehat/';
        ...
        if ($uploadOk == 0) {
            ...
            if (move_uploaded_file($_FILES['file']['tmp_name'], $target_file)) {
                ...
                mysqli_query($conn, "UPDATE p_kotasehat SET judul = '$judul', author = '$author', text = '$desc', data = '$data', tanggal = '$tgl' WHERE id = '$id_kotasehat'");
		...
		mysqli_query($conn, "UPDATE p_kotasehat SET judul = '$judul', author = '$author', text = '$desc', data = '$data' WHERE id = '$id_kotasehat'");
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Kota Sehat / Table Kota Sehat /</span> Edit Data</h4>
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="judul" name="judul" value="<?= $kotasehat['judul']; ?>" />
                                            </div>
                                            <div class="mb-3">
                                                <label for="author" class="form-label">Author</label>
                                                <input type="text" class="form-control" id="author" name="author" value="<?= $kotasehat['author']; ?>" />
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" id="deskripsi" name="deskripsi" rows="3"><?= $kotasehat['text']; ?></textarea>
                                            </div>
                                            <div class="mb-3">
                                                <label for="file" class="form-label">Input Data</label>
                                                <meta src="../assets/data/kotasehat/<?= $kotasehat['data']; ?>">
