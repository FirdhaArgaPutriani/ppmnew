            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Kota Sehat /</span> Table Kota Sehat
                        </h4>
                        <div class="card-body">
                            <a href="http://localhost/ppmnew/kotasehat_admin/tambah.php">
                                <button type="button" class="btn rounded-pill btn-primary">Add Data</button>
                            </a>
                        </div>
                        <!-- Basic Table -->
                        <div class="card">
                            <h5 class="card-header">Kota Sehat</h5>
                                ...
                                <table class="table">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        ...
                                        if (isset($_GET['query'])) {
                                            ...
                                            $get_data = mysqli_query($conn, "SELECT * FROM p_kotasehat");
                                        }
