...
if (isset($_POST['submit'])) {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES['file']['tmp_name'], $target_file)) {
            ...
            mysqli_query($conn, "INSERT INTO p_kotasehat (judul, author, text, data, tanggal) VALUES ('$judul', '$author', '$desc', '$data', '$tgl')");
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Kota Sehat / Table Kota Sehat /</span> Input Data</h4>
