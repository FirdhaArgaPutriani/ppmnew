            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Ranham / Article /</span> <?= $ranham['judul']; ?></h4>
                        <div class="card mb-4">
                            <div class="card-body">
                                <h5 class="card-title"><?= $ranham['judul']; ?></h5>
                                <div class="card-subtitle text-muted mb-3"><?= $ranham['tanggal']; ?>, <?= $ranham['author']; ?></div>
                                <p class="card-text">
                                    <?= $ranham['text']; ?>
                                </p>
                                <p>
                                <a href="download.php?filename=<?= urlencode($ranham['data']); ?>">
                                <i class="<?= getFileIcon($ranham['data']); ?>"></i> <?= $ranham['data']; ?>
                                </p>
                            </div>
                        </div>
                    </div>
