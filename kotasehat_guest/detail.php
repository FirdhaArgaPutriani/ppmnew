            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Kota Sehat / Article /</span> <?= $kotasehat['judul']; ?></h4>
                        <div class="card mb-4">
                            <div class="card-body">
                                <h5 class="card-title"><?= $kotasehat['judul']; ?></h5>
                                <div class="card-subtitle text-muted mb-3"><?= $kotasehat['tanggal']; ?>, <?= $kotasehat['author']; ?></div>
                                <p class="card-text">
                                    <?= $kotasehat['text']; ?>
                                </p>
                                <p>
                                <a href="download.php?filename=<?= urlencode($kotasehat['data']); ?>">
                                <i class="<?= getFileIcon($kotasehat['data']); ?>"></i> <?= $kotasehat['data']; ?>
                                </p>
                            </div>
                        </div>
                    </div>
