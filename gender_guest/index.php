...
$gender = query("SELECT * FROM pm_gender");
?>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Gender /</span> Article</h4>
                            ...
                            <div class="col-md mb-4 mb-md-0">
                                <div class="accordion mt-3" id="accordionExample">
                                    ...
                                    if (isset($_GET['query'])) {
                                        ...
                                        $get_data = mysqli_query($conn, "SELECT * FROM pm_gender WHERE judul LIKE '%$search_query%' OR data LIKE '%$search_query%'");
                                    } else {
                                        $get_data = mysqli_query($conn, "SELECT * FROM pm_gender ORDER BY tanggal DESC");
                                    }
