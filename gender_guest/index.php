...
$gender = query("SELECT * FROM p_gender");
?>
                            ...
                            <div class="col-md mb-4 mb-md-0">
                                <div class="accordion mt-3" id="accordionExample">
                                    ...
                                    if (isset($_GET['query'])) {
                                        ...
                                        $get_data = mysqli_query($conn, "SELECT * FROM p_gender WHERE judul LIKE '%$search_query%' OR data LIKE '%$search_query%'");
                                    } else {
                                        $get_data = mysqli_query($conn, "SELECT * FROM p_gender ORDER BY tanggal DESC");
                                    }
