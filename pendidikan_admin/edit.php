...
$query = mysqli_query($conn, "SELECT * FROM pm_pendidikan WHERE id = $id_pendidikan");
    ...
    if ($_FILES['file']['tmp_name']) {
        ...
        if ($uploadOk == 0) {
            ...
            if (move_uploaded_file($_FILES['file']['tmp_name'], $target_file)) {
                ...
                mysqli_query($conn, "UPDATE pm_pendidikan SET judul = '$judul', author = '$author', text = '$desc', data = '$data', tanggal = '$tgl' WHERE id = '$id_pendidikan'");
		...
		mysqli_query($conn, "UPDATE pm_pendidikan SET judul = '$judul', author = '$author', text = '$desc', data = '$data' WHERE id = '$id_pendidikan'");
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Pendidikan / Table Pendidikan /</span> Edit Data</h4>
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="judul" name="judul" value="<?= $pendidikann['judul']; ?>" />
                                            </div>
                                            <div class="mb-3">
                                                <label for="author" class="form-label">Author</label>
                                                <input type="text" class="form-control" id="author" name="author" value="<?= $pendidikan['author']; ?>" />
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" id="deskripsi" name="deskripsi" rows="3"><?= $pendidikan['text']; ?></textarea>
                                            </div>
                                            <div class="mb-3">
                                                <label for="file" class="form-label">Input Data</label>
                                                <meta src="../assets/data/pendidikan/<?= $pendidikan['data']; ?>">
