            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">SDG / Article /</span> <?= $sdg['judul']; ?></h4>
                        <div class="card mb-4">
                            <div class="card-body">
                                <h5 class="card-title"><?= $sdg['judul']; ?></h5>
                                <div class="card-subtitle text-muted mb-3"><?= $sdg['tanggal']; ?>, <?= $sdg['author']; ?></div>
                                <p class="card-text">
                                    <?= $sdg['text']; ?>
                                </p>
                                <p>
                                <a href="download.php?filename=<?= urlencode($sdg['data']); ?>">
                                <i class="<?= getFileIcon($sdg['data']); ?>"></i> <?= $sdg['data']; ?>
                                </p>
                            </div>
                        </div>
                    </div>
