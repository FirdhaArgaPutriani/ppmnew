...
$id_ipm = $_GET['id'];
$query = mysqli_query($conn, "SELECT * FROM pm_ipm WHERE id = $id_ipm");
$ipm = mysqli_fetch_assoc($query);
    ...
    if ($_FILES['file']['tmp_name']) {
        ...
        if ($uploadOk == 0) {
            ...
            if (move_uploaded_file($_FILES['file']['tmp_name'], $target_file)) {
                ...
                mysqli_query($conn, "UPDATE pm_ipm SET judul = '$judul', author = '$author', tgl_kasus = '$tgl_kasus', jumlah = '$jumlah', text = '$desc', data = '$data', tanggal = '$tgl' WHERE id = '$id_ipm'");
		...
		mysqli_query($conn, "UPDATE pm_ipm SET judul = '$judul', author = '$author', tgl_kasus = '$tgl_kasus', jumlah = '$jumlah', text = '$desc', data = '$data' WHERE id = '$id_ipm'");
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">IPM / Table IPM /</span> Edit Data</h4>
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="judul" name="judul" value="<?= $ipm['judul']; ?>" />
                                            </div>
                                            <div class="mb-3">
                                                <label for="author" class="form-label">Author</label>
                                                <input type="text" class="form-control" id="author" name="author" value="<?= $ipm['author']; ?>" />
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control" id="tgl_kasus" name="tgl_kasus" value="<?= $ipm['author']; ?>" />
                                            </div>
                                            <div class="mb-3">
                                                <label for="author" class="form-label">Number of Cases</label>
                                                <input type="text" class="form-control" id="jumlah" name="jumlah" placeholder="Number of Cases" value="<?= $ipm['author']; ?>"/>
                                            </div>
                                            <div class="mb-3">
                                                <label for="deskripsi" class="form-label">Description</label>
                                                <textarea class="form-control" id="deskripsi" name="deskripsi" rows="3"><?= $ipm['text']; ?></textarea>
                                            </div>
                                            <div class="mb-3">
                                                <label for="file" class="form-label">Input Data</label>
                                                <meta src="../assets/data/ipm/<?= $ipm['data']; ?>">
