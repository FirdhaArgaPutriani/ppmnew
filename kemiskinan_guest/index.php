...
$kemiskinan = query("SELECT * FROM pm_kemiskinan");
?>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Kemiskinan /</span> Article</h4>

                        <!-- Accordion -->
                        <h5 class="mt-4">Kemiskinan</h5>
                        <div class="row">
