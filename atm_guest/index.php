            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">ATM /</span> Article</h4>

                        <!-- Accordion -->
                        <h5 class="mt-4">ATM</h5>
                        <div class="row">
                            <div class="col-md mb-4 mb-md-0">
                                <div class="accordion mt-3" id="accordionExample">
                                    ...
                                    if (isset($_GET['query'])) {
                                        ...
                                        $get_data = mysqli_query($conn, "SELECT * FROM p_atm ORDER BY tanggal DESC");
                                    }
