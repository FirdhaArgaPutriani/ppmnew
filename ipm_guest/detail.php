            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">IPM / Article /</span> <?= $ipm['judul']; ?></h4>
                        <div class="card mb-4">
                            <div class="card-body">
                                <h5 class="card-title"><?= $ipm['judul']; ?></h5>
                                <div class="card-subtitle text-muted mb-3"><?= $ipm['tanggal']; ?>, <?= $ipm['author']; ?></div>
                                <p class="card-text">
                                    <?= $ipm['text']; ?>
                                </p>
                                <p>
                                <a href="download.php?filename=<?= urlencode($ipm['data']); ?>">
                                <i class="<?= getFileIcon($ipm['data']); ?>"></i> <?= $ipm['data']; ?>
                                </p>
                            </div>
                        </div>
                    </div>
