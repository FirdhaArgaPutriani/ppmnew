            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Ranham /</span> Table Ranham</h4>
                        <div class="card-body">
                            <a href="http://localhost/ppmnew/ranham_admin/tambah.php">
                                ...
                                <table class="table">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        ...
                                        if (isset($_GET['query'])) {
                                            ...
                                            $get_data = mysqli_query($conn, "SELECT * FROM p_ranham WHERE judul LIKE '%$search_query%' OR data LIKE '%$search_query%'");
                                        } else {
                                            $get_data = mysqli_query($conn, "SELECT * FROM p_ranham ORDER BY tanggal DESC;");
                                        }
