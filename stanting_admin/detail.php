            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Stunting / Table Stunting /</span> Detail <?= $stunting['judul']; ?></h4>
                        <div class="row mb-5">
                            <div class="col-md-6 col-lg-12">
                                <h5 class="mt-2 text-muted"><?= $stunting['judul']; ?></h5>
                                <div class="card mb-4">
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item">Author &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : <?= $stunting['author']; ?></li>
                                        <li class="list-group-item">Date of Cases &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : <?= $stunting['tgl_kasus']; ?></li>
                                        <li class="list-group-item">Number of Cases &nbsp;: <?= $stunting['jumlah']; ?></li>
                                        <li class="list-group-item">Description &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : <?= $stunting['text']; ?></li>
                                        <li class="list-group-item">
                                            Data &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :
                                            <a href="download.php?filename=<?= urlencode($stunting['data']); ?>">
                                                <i class="<?= getFileIcon($stunting['data']); ?>"> </i>
                                                <?= $stunting['data']; ?>
                                            </a>
                                        </li>
                                        <li class="list-group-item">Upload Date &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : <?= $stunting['tanggal']; ?></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
